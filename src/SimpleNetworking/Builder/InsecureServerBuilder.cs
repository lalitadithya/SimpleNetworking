...
namespace SimpleNetworking.Builder
{
    ...
    public class InsecureServerBuilder
    {
        ...
        public InsecureServerBuilder WithKeepAliveTimeOut(TimeSpan keepAliveTimeOut)
        {
            this.keepAliveTimeOut = (int)keepAliveTimeOut.TotalMilliseconds;
            return this;
        }

        public InsecureServerBuilder WithKeepAliveResponseTimeOut(TimeSpan keepAliveResponseTimeOut)
        {
            this.keepAliveResponseTimeOut = (int)keepAliveResponseTimeOut.TotalMilliseconds;
            return this;
        }

        public InsecureServerBuilder WithMaximumNumberOfKeepAliveMisses(int maximumNumberOfKeepAliveMisses)
        {
